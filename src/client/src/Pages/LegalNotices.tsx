  ...
  return (
    <div className="fr-container fr-my-5w">
      ...
      <p>
        ...
        de mission IDNUM chez direction interministérielle du numérique (DINUM).
      </p>
      ...
      <p>
        ...
        sur agentconnect.gouv.fr. Sauf mention de propriété intellectuelle
        ...
        site source agentconnect.gouv.fr est recommandée.
      </p>
