...
function ServiceDirectory(){
    ...
    const filteredOffres = availableToPrivate ? offres_fi.filter((offre) => offre.openPrivate) : offres_fi;

    return(
        <div className="fr-container">
            <h1 className="fr-h3 fr-mt-2w">Annuaire des entreprises</h1>
            <p>Avec ProConnect, accédez à de nombreux outils et sites de l'administation, en un clic !</p>
            <ToggleSwitch
                style={{
                    maxHeight: "0"
                }}
