...
function Partners() {
  return (
    <div className="fr-container fr-mt-2w">
          ...
          <tbody>
            {PARTNERS_LIST.map((PARTNER_LIST) => (
              <tr key={PARTNER_LIST.structure}>
                ...
                <td>
                  {renderIdentityProviders(PARTNER_LIST.identityProviders)}
                </td>
                <td>
      ...
      <p>
        Aucun problème, vous pouvez utiliser AgentConnect ! <br /> Nous nous
        assurons nous-même que vous faites partie de la Fonction Publique en
        vérifiant <br />
